...
La aplicación de Gymkhana App se apoya principalmente sobre tres views: Start, Challenge y Response.

\subparagraph{Start}
Esta página muestra los juegos que hay disponibles en la aplicación, los lista ordenadamente de manera descendientes, y cada juego tiene un botón en el que pinchando accedes al juego concreto. 
\subparagraph{Challenge} 
En esta página muestra un único reto, que se compone de un nombre o título, una pregunta y una imagen con un diagrama UML que debe estar relacionado con el reto. Esta vista tiene también un campo que el usuario debe rellenar con la respuesta planteada al reto y un botón par enviar la petición GET con la respuesta al servidor.
