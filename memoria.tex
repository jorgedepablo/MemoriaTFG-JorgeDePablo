...
\LARGE
FIXME: TÍTULO DEL TRABAJO EN MAYÚSCULAS
...
\vspace{1cm}
\large
FIXME: Título del Trabajo con Letras Capitales para Sustantivos y Adjetivos
...
FIXME: aquí estaría bien añadir una figura (y referenciarla en el texto... mira cómo lo he hecho con las anteriores. Recuerda que hay que compilar dos veces para que se creen las referencias).
...
FIXME: no me queda claro si utilizas Postgres, SQLite o los dos... debería qeudar más claro
...
\begin{figure}
	...
	\caption{Estructura de las relación modelo-vista-controlador. FIXME: esto debería ir a estado del arte, porque no es de tu cosecha}\label{fig:arquitectura}
\end{figure}
