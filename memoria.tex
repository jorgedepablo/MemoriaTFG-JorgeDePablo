...
\begin{itemize}
	...
	\item Distribución y redundancia. Estas unidades de procesamiento al estar aisladas implican que, si existen fallos en la infraestructura de una de ellas, las otras no se verán afectadas y en consecuencia tampoco sus servicios. 	
\end{itemize}
...
Esta página funciona de manera muy parecida a la anterior, y solo se tendrá acceso aquel usurario que se ha registrado a través del inicio de sesión. Consiste, al igual que en el módulo anterior, en rellenar un formulario sencillo, en el que esta vez solo es necesario añadir un título del juego y seleccionar en el menú desplegable uno o varios retos que compondrán dicho juego. 
